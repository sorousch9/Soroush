...
import susuplay1 from "../../assets/susuplay1.webp";
import susuplay2 from "../../assets/susuplay2.webp";
import susuplay3 from "../../assets/susuplay3.webp";
import susuplay4 from "../../assets/susuplay4.webp";
          ...
          >
            <Row className="works-wrapper">
              <Col md={4}>
                ...
                >
                  <h3>Susu Player</h3>
                  <h6>This is a music player app built using React, Redux, and React-Bootstrap. It allows users to browse, search, and play songs from a curated library.</h6>
                  <div className="dependencies-ico">
                    <i>
                      TypeScript
                      <span>
